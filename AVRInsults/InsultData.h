...
#define P_STR(NAME,STRING) const char const NAME[] PROGMEM = STRING
#define P_STRA(NAME,...)  const PGM_P const NAME[] PROGMEM = { __VA_ARGS__ }
//#define P_STRAA(NAME,SIZE,...) char[]* const NAME[SIZE] PROGMEM = { __VA_ARGS__ }

P_STR( token_001, "root"       );
P_STR( token_002, "adverb"     );
P_STR( token_003, "relation"   );
P_STR( token_004, "derog"      );
P_STRA(tokenNames,token_001,token_002,token_003,token_004);
...
P_STRA(roots,root_001,root_002,root_003,root_004,root_005,root_006);
...
P_STRA(derog,derog_001,derog_002,derog_003,derog_004,derog_005,derog_006,derog_007,derog_008);